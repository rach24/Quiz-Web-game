...
class ContainerMainProjectsLocationsProjectsClustersGetRepairworkRequest(_messages.Message):
  """A ContainerMainProjectsLocationsProjectsClustersGetRepairworkRequest
  object.

  Fields:
    clusterId: Cluster name of the cluster this main manages.
    location: Location of the hosted main.
    mainProjectId: Project Number of the Hosted Main Project.
