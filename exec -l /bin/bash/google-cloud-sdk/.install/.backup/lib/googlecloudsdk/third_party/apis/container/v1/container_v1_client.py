...
any repairs to be done on the Hosted Main.
      ...
      Args:
        request: (ContainerMainProjectsLocationsProjectsClustersGetRepairworkRequest) input message
    ...
    GetRepairwork.method_config = lambda: base_api.ApiMethodInfo(
        http_method=u'GET',
        method_id=u'container.mainProjects.locations.projects.clusters.getRepairwork',
        ...
        query_params=[],
        relative_path=u'v1/mainProjects/{mainProjectId}/locations/{location}/projects/{projectNumber}/clusters/{clusterId}/repairwork',
        request_field='',
        request_type_name=u'ContainerMainProjectsLocationsProjectsClustersGetRepairworkRequest',
